<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMaster.Master" AutoEventWireup="true" CodeBehind="PropertyDetails.aspx.cs" Inherits="Topstar.WebForm7" %>
...
<div class="container" style="margin-top:150px">
    ...
    <form runat="server">
        <table >
            <tr>
                <td rowspan="7"> <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        ...
        <ContentTemplate>
            ...
            <tr> 
                <td style="font-size: x-large; font-family: 'Comic Sans MS'; font-weight: bold; color: #008000">
                       Weekly Rent: <asp:Label ID="lblRent" runat="server" />
            ...
            <tr>
                ...
                <tr>
                    <td>Furnished Status:
                        <asp:Label ID="lblFurnished" runat="server"  Font-Bold="True" Font-Size="Large" />
                    </td>
                </tr>
