    ...
    public partial class WebForm17 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            using (SqlConnection sqlCon = new SqlConnection(connectionString))
            {
                ...
                //    {
                string query = "select p.propertyid, p.streetNo, p.streetName, p.suburb, p.district, p.city, p.noOfBedrooms, p.noOfBathrooms, p.parking, p.type, p.description,p.area, p.special , p.specialPrice, p.availability, b.price from tbproperty p, tbbproperty b, tbimages m where p.propertyid=b.propertyid and p.propertyid = m.propertyid and m.DefaultValue = 'Yes' and p.propertyid='" + propertyid + "'";
